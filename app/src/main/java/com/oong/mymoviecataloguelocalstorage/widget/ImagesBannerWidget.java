...
public class ImagesBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.oong.mymoviecataloguelocalstorage.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.oong.mymoviecataloguelocalstorage.EXTRA_ITEM";
